...
40. Kunert JM, Proctor JL, Brunton SL, Kutz J: **Spatiotemporal feedback and network structure drive and encode *Caenorhabditis elegans* locomotion.** *PLoS Comput Biol* 2017, **13**, e1005303, .
    * Dimensional reduction of neural dynamics from simulations of a full-connectome, disembodied model produce a low dimensional representation that enables system-wide comparison of the neural dynamics pre- and post-ablation of locomotion motorneurons and interneurons.
...
57. McIntire SL, Jorgensen E, Kaplan J, Horvitz HR: **The GABAergic nervous system of *Caenorhabditis elegans*.** *Nature* 1993, **364**:337–341, .
...
* Neuronal ablation experiments, optogenetics and severing of the ventral and dorsal nerve cords are used to show that isolating sections of the motor circuit produces oscillations at different frequencies along the body. Ablating most command interneurons does not eliminate body oscillations, which require B-class motoneurons.
...
70. Wen Q, Po MD, Hulme E, Chen S, Liu X, Kwok SW, Gershow M, Leifer AM, Butler V, Fang-Yen C: **Proprioceptive coupling within motor neurons drives *C. elegans* forward locomotion.** *Neuron* 2012, **76**:750–761, .

71. Olivares EO, Izquierdo EJ, Beer RD: **Potential role of a ventral nerve cord central pattern generator in forward and backward locomotion in *Caenorhabditis elegans*.** *Netw Neurosci* 2018, **2**:323–343, .
...
72. Izquierdo EJ, Beer RD: **An integrated neuromechanical model of steering in *C. elegans*.** In *Proceeding of the European Conference on Artificial Life*; 2015:199–206, .

73. Izquierdo EJ, Beer RD: **From head to tail: a neuromechanical model of forward locomotion in *Caenorhabditis elegans*.** *Philos Trans R Soc Lond Ser B Biol Sci* 2018, **373**:1–12, .

74. Fieseler C, Kunert-Graf J, Kutz JN: **The control structure of the nematode *Caenorhabditis elegans*: neuro-sensory integration and proprioceptive feedback.** *J Biomech* 2018, **74**:1–8, .

75. Niebur E, Erdös P: **Theory of the locomotion of nematodes.** *Biophys J* 1991, **60**:1132–1146, .

76. Karbowski J, Schindelman G, Cronin CJ, Seah A, Sternberg PW: **Systems level circuit model of *C. elegans* undulatory locomotion: mathematical modeling and molecular genetics.** *J Comput Neurosci* 2008, **24**:253–276, .

77. Liu P, Chen B, Wang Z-W: **SLO-2 potassium channel is an important regulator of neurotransmitter release in *Caenorhabditis elegans*.** *Nat Commun* 2014, **5**:5155, .

78. Kawano T, Po MD, Gao S, Leung G, Ryu WS, Zhen M: **An imbalancing act: gap junctions reduce the backward motor circuit activity to bias *C. elegans* for forward locomotion.** *Neuron* 2011, **72**:572–586, .

79. Liu P, Chen B, Mailler R, Wang Z-W: **Antidromic-rectifying gap junctions amplify chemical transmission at functionally mixed electrical-chemical synapses.** *Nat Commun* 2017, **8**:14818, .

80. Gao S, Guan SA, Fouad AD, Meng J, Kawano T, Huang Y-C, Li Y, Alcaire S, Hung W, Lu Y, Qi YB, Jin Y, Alkema M, Fang-Yen C, Zhen M: **Excitatory motor neurons are local oscillators for backward locomotion.** *eLife* 2018, **7**:e29915, .
...
81. Pierce-Shimomura JT, Chen BL, Mun JJ, Ho R, Sarkis R, McIntire SL: **Genetic analysis of crawling and swimming locomotory patterns in *C. elegans*.** *Proc Natl Acad Sci USA* 2008, **105**:20982–20987, .

82. Sznitman J, Shen X, Purohit PK, Arratia PE: **The effects of fluid viscosity on the kinematics and material properties of *C. elegans* swimming at low Reynolds number.** *Exp Mech* 2010, **50**:1303–1311, .

83. Lebois F, Sauvage P, Py C, Cardoso O, Ladoux B, Hersen P, Di Meglio JM: **Locomotion control of *Caenorhabditis elegans* through confinement.** *Biophys J* 2012, **102**:2791–2798, .
...
100. Mujika A, Leskovský P, Álvarez R, Otaduy MA, Epelde G: **Modeling behavioral experiment interaction and environmental stimuli for a synthetic *C. elegans*.** *Front Neuroinf* 2017, **11**:71, .
