...
Ankur Sinha^1†, Padraig Gleeson^1\*†, Bóris Marin^2, Salvador Dura-Bernal^3,4, Sotirios Panagiotou^5, Sharon Crook^6, Matteo Cantarelli^7, Robert C Cannon^8, Andrew P Davison^9, Harsha Gurnani^10, Robin Angus Silver^1\*
...
|a.b.c.d.|ConductancesCellsNetworksNeuroML|
|-|-|
...
||1) NeuroML reference simulators|2) Native NeuroML simulators|3) Simulators import NeuroML|4) Generated simulator scripts|5) Other standardized formats|
|-|-|-|-|-|-|
|---|---|---|---|---|---|
||jNeuroML|EDEN|NetPyNE|NEURON|PyNN|
||PyLEMS||MOOSE|Brian2|SONATA|
||||||SBML|
...
\hline
**Tool** & **Abstract cell** & **Single compartment** & **Multiple compartment** & **Conductance-based** & **Parallel** \\
& **models** & **cells** & **cells** & **models** & **execution** \\
\hline
...
iMemb = \frac{C(v\_scaling(\phi - z))}{MSEC} + iSyn \quad (4)
...
* iMemb = (C \* (v\_scaling \* (phi - z) / MSEC)) + iSyn (exposed as iMemb)
