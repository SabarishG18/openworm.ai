...
field = "general"  # general/science/celegans
iteration_per_day = 1
current_date = datetime.datetime.now().strftime("%d-%m-%y")
SOURCE_QUESTIONS_FILE = "openworm_ai/quiz/samples/huggingface_Qwen_Qwen2.5-72B-Instruct_100questions_general_v2.json"
...
TITLE = "Performance of LLMs in a specific 100 MCQ General Knowledge Quiz"
...
def load_llms():
    ...
    llms = [
        ...
        LLM_HF_COHERE_AYA_32B,  # 8B - Cohere model
    ]
    # Defined constants
